...
<link rel="stylesheet" href="/resources/css/admin/gView.css">
		...
		<section id="container">
			...
			<div id="container_box">
				...
				<form role="form" method="post" autocomplete="off">
					...
					<div class="inputArea">
						<label>1차 분류</label> <span class="category1"> <label>2차 분류</label> <span class="category2">${goods.cateCode}
					</div>
					...
					<div class="inputArea">
						<label for="gdsPrice">상품가격</label> <span><fmt:formatNumber value="${goods.gdsPrice}" pattern="###,###,###" />
					</div>
					...
					<div class="inputArea">
						<label for="gdsDes">상품소개</label> <span><div class="gdsDes">${goods.gdsDes}</div>
					</div>
